...
import 'package:downloader_inappbrowser/inline_example.screen.dart';
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: InkWell(onTap: (){
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => new InlineExampleScreen()),
          );
        },child: new Text("Click here to go to webview")),
      ),
      body: Builder(
